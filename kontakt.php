    ...
    <section class="container">
      <div class="row">
        ...
        <div class="col-50 text-right">
          <h3>Napíšte nám</h3>
          <form id="contact" method="POST" action="thankyou.php">
            ...
            <input type="checkbox" name="suhlasim" id="suhlasim" required>
            <label for="suhlasim"> Súhlasím so spracovaním osobných údajov.</label><br>
